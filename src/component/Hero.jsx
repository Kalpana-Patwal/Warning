...
const Hero = () => {
    return (
      <div className="px-6 py-12 max-w-4xl mx-auto relative font-geologica md:px-8 lg:px-10">
        ...
        <p className="text-gray-700 mb-10 text-sm md:text-base lg:text-lg">
        ...
        <div className="text-black mb-8 leading-[32px] md:mb-10">
          <p className="font-normal mb-4 text-sm md:text-base lg:text-lg">
        ...
        <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 
          ...
          <button className="w-full bg-[#ff4b4b] !text-whitish py-2 rounded-lg hover:bg-[#ff3b30] transition-colors text-xs md:text-sm md:py-3 lg:text-base">
            OK
          </button>
        </div>
        ...
        <div className="fixed bottom-4 left-1/2 transform -translate-x-1/2 w-[300px] bg-whitish rounded-xl z-50
          ...
          <button className="w-full py-3 text-center text-sm font-medium md:text-base md:py-4 lg:text-lg">
            OK
          </button>
        </div>
      </div>
